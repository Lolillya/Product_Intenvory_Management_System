package com.example.angelaoten;
...
class InventoryManager {
    ...
    private List<String> readFileContent() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\admin\\IdeaProjects\\AngelaOten\\src\\main\\resources\\com\\example\\angelaoten\\inventory.txt"))) {
            String line;
            while ((line = reader.readLine()) != null) {
                lines.add(line);
            }
